...
{
    /// <inheritdoc />
    public partial class postgresql_migration_392 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_favoritProducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_favoritProducts_products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_favoritProducts_users_UserId",
                        column: x => x.UserId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_favoritProducts_ProductId",
                table: "favoritProducts",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_favoritProducts_UserId",
                table: "favoritProducts",
                column: "UserId");
